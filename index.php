...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md relative">
        <h2 class="text-2xl font-bold text-gray-700 mb-6 text-center">Statements SPA Import</h2>
        ...
        <div class="flex justify-between">
            ...
            <a href="import-xlsx.php" class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-50" onclick="importXLSX()">
                Import XLSX
            </a>
        </div>
